...
namespace TehGM.EinherjiBot
{
    public static class DiscordGuildExtensions
    {
        ...
        public static Task<IGuildUser> GetGuildUserAsync(this IGuild guild, IUser user, CancellationToken cancellationToken = default)
            => GetGuildUserAsync(guild, user.Id, cancellationToken);
