...
namespace TehGM.EinherjiBot.Administration
{
    ...
    public class VoiceChannelsCommandsHandler
    {
        ...
        public VoiceChannelsCommandsHandler(DiscordSocketClient client, ILogger<VoiceChannelsCommandsHandler> log, IOptionsMonitor<CommandsOptions> commandsOptions)
        {
            this._client = client;
            this._log = log;
